...
const AdminGenre = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://rden88m8ii.execute-api.ap-southeast-1.amazonaws.com/dreamstreamerStage/genre')
      .then(response => {
        if (!response.ok) {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <GenreView albums={albums} onEdit={handleEditAlbum} onDelete={handleDeleteAlbum} />
    </div>
  );
};
